...
def python_ScalerxBR(timg, tdrawable, scale_factor = 2):
    ...
    gimp.progress_init("Running first pass of Scaler-xBR on " + tdrawable.name + "...")
    ...
    # Second pass
    gimp.progress_init("Running second pass of Scaler-xBR on " + tdrawable.name + "...")
    ...
    # Third pass
    gimp.progress_init("Running third pass of Scaler-xBR on " + tdrawable.name + "...")
...
register(
    "scaler_xBR",
    "Integer scales an image by a power of 2 using Scaler-xBR",
    "Integer scales an image by a power of 2 using Scaler-xBR",
    "SpaceOak",
    "H",
    "2021",
    "<Image>/Filters/Enhance/Scaler-xBR(py)...",
    "RGB, RGBA",
    [
        (PF_INT, "scale_factor", "Scale factor( 2^x ( 2, 4, 8, etc ) )", 2)
    ],
    [],
    python_ScalerxBR)
